...
oak.blasts = lapply(dir(patt = 'txt'), read.delim)
names(oak.blasts) = c('quercus.all', 'est.others', 'ref.seq.RNA')
...
stats.of.interest <- c('number of hits', 'number of unique descriptions', 'descriptions concatenated', 'QUERCUS', 'EST.OTHERS', 'REF.SEQ.RNA')
